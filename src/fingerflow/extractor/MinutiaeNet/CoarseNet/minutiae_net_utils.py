...
def get_quality_map_ori_dict(img, data_dict, spacing, dir_map=None, block_size=16):
    ...
    img = np.pad(img, (pad_size, pad_size), 'symmetric')
...
def smooth_dir_map(dir_map, sigma=2.0, mask=None):
    ...
    cos_2_theta = filters.gaussian(cos_2_theta, sigma, channel_axis=None, mode='reflect')
    sin_2_theta = filters.gaussian(sin_2_theta, sigma, channel_axis=None, mode='reflect')
